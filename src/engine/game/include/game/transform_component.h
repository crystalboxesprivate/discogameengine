...
struct TransformComponent : public Component {
  ...
  TransformComponent()
      : Component(), position(glm::vec3(0)), scale3d(glm::vec3(1.f)), transform_matrix(glm::mat4(1.f)) {
  ...
  glm::vec3 get_mesh_orientation_euler_angles(bool is_degrees = false);
  glm::vec3 get_forward(glm::vec3 forwardModelSpace = glm::vec3(0.f, 0.f, 1.f));
